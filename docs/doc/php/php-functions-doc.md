# Class \Xlient\Doc\Php\PhpFunctionsDoc
...
## Class Synopsis
```php
class PhpFunctionsDoc extends \Xlient\Doc\Php\AbstractPhpDoc
{
    /* Properties */
...
| [$functions](#functions) | array<PhpFunction> | An array of functions to put in this documentation. |
...
| Name | Description |
| :--- | :--- |
| [add()](/docs/doc/php/php\-functions\-doc/add.md) | Adds a function to this documentation file. |
| [getDocComment()](/docs/doc/php/php\-functions\-doc/get\-doc\-comment.md) | Gets the PHPDoc comment associated with this documentation item. |
| [getName()](/docs/doc/php/php\-functions\-doc/get\-name.md) | Gets the fully qualified name of this documentation item. |
| [make()](/docs/doc/php/php\-functions\-doc/make.md) | Generates all documentation files for this documentation item. |
| [makeFunctionDetails()](/docs/doc/php/php\-functions\-doc/make\-function\-details.md) | Generates markdown for more detailed information about the functions in this documentation file. |
| [makeFunctionFiles()](/docs/doc/php/php\-functions\-doc/make\-function\-files.md) | Generates separate files for each function. |
| [makeFunctions()](/docs/doc/php/php\-functions\-doc/make\-functions.md) | Generates markdown for a list of functions contained in this documentation file. |
| [makeFunctionsTable()](/docs/doc/php/php\-functions\-doc/make\-functions\-table.md) | Generates markdown for a list of functions contained in this documentation file in a table format. |
| [makeSynopsis()](/docs/doc/php/php\-functions\-doc/make\-synopsis.md) | Generates markdown for a code snyopsis of this documentation file. |
| [makeSynopsisMeta()](/docs/doc/php/php\-functions\-doc/make\-synopsis\-meta.md) | Generates meta JSON files to allow for linking in code sysnopsis after syntax highlighting. |
| [setDocComment()](/docs/doc/php/php\-functions\-doc/set\-doc\-comment.md) | Sets the PHPDoc comment associated with this documentation item. |

### Protected

| Name | Description |
| :--- | :--- |
| [getAnchor()](/docs/doc/php/php\-functions\-doc/get\-anchor.md) | Gets an anchor from a fully qualified name. |
| [getClassCaseDefinition()](/docs/doc/php/php\-functions\-doc/get\-class\-case\-definition.md) | Gets a PHP code definition for the specified enumeration case reflector. |
| [getClassConstantDefinition()](/docs/doc/php/php\-functions\-doc/get\-class\-constant\-definition.md) | Gets a PHP code definition for the specified class constnat reflector. |
| [getClassDefinition()](/docs/doc/php/php\-functions\-doc/get\-class\-definition.md) | Gets a PHP code definition for the specified class reflector. |
| [getClassFilename()](/docs/doc/php/php\-functions\-doc/get\-class\-filename.md)<br>_Internal_ | Gets a filename from the specified fully qualified name, prefix and suffix. |
| [getClassInterfaces()](/docs/doc/php/php\-functions\-doc/get\-class\-interfaces.md) | Gets an array of fully qualified interface names implemented by the class of the class reflector. |
| [getClassReflectionConstants()](/docs/doc/php/php\-functions\-doc/get\-class\-reflection\-constants.md) | Gets an array of class constant reflectors that exist in the specified class reflector. |
| [getClassReflectionMethods()](/docs/doc/php/php\-functions\-doc/get\-class\-reflection\-methods.md) | Gets an array of method reflectors that exist in the specified class reflector. |
| [getClassReflectionProperties()](/docs/doc/php/php\-functions\-doc/get\-class\-reflection\-properties.md) | Gets an array of property reflectors that exist in the specified class reflector. |
| [getDefaultParameterValues()](/docs/doc/php/php\-functions\-doc/get\-default\-parameter\-values.md) | Gets an array of default function or method parameter values. |
| [getDirPath()](/docs/doc/php/php\-functions\-doc/get\-dir\-path.md) | Gets a directory path for the specified fully qualified name. |
| [getExternalUrl()](/docs/doc/php/php\-functions\-doc/get\-external\-url.md) | Gets an external URL for the specified fully qualified name if one can be determined. |
| [getFile()](/docs/doc/php/php\-functions\-doc/get\-file.md) | Gets a file for the specified fully qualified name. |
| [getFilename()](/docs/doc/php/php\-functions\-doc/get\-filename.md) | Gets a filename from the specified fully qualified name. |
| [getFunctionData()](/docs/doc/php/php\-functions\-doc/get\-function\-data.md) | Gets the markdown encoded name, description, url, and marks of the specified function. |
| [getFunctionDefinition()](/docs/doc/php/php\-functions\-doc/get\-function\-definition.md) | Gets a PHP code definition for the specified function or method reflector. |
| [getFunctionFile()](/docs/doc/php/php\-functions\-doc/get\-function\-file.md) | Gets a filename for the specified function short name. |
| [getFunctionParameterData()](/docs/doc/php/php\-functions\-doc/get\-function\-parameter\-data.md) | Gets the markdown encoded name, type, and description of the specified function parameter. |
| [getFunctionReturnData()](/docs/doc/php/php\-functions\-doc/get\-function\-return\-data.md) | Gets the markdown encoded type, and description of the specified function return. |
| [getFunctionUrl()](/docs/doc/php/php\-functions\-doc/get\-function\-url.md) | Gets a URL for the specified function short name. |
| [getPropertyDefinition()](/docs/doc/php/php\-functions\-doc/get\-property\-definition.md) | Gets a PHP code definition for the specified property reflector. |
| [getTypeDefinition()](/docs/doc/php/php\-functions\-doc/get\-type\-definition.md) | Gets a PHP code definition for the specified type. |
| [getTypeDefinitionFromValue()](/docs/doc/php/php\-functions\-doc/get\-type\-definition\-from\-value.md) | Gets a type definition of the specified value. |
| [getUrl()](/docs/doc/php/php\-functions\-doc/get\-url.md) | Gets a URL for the specified fully qualified name. |
| [getUrlPath()](/docs/doc/php/php\-functions\-doc/get\-url\-path.md) | Gets a URL path from the specified fully qualified name. |
| [inheritDocComment()](/docs/doc/php/php\-functions\-doc/inherit\-doc\-comment.md) | Handles inheriting PHPDoc comments when @inheritDoc is present. |
| [makeCase()](/docs/doc/php/php\-functions\-doc/make\-case.md) | Generates markdown for an enum case definition. |
| [makeConstant()](/docs/doc/php/php\-functions\-doc/make\-constant.md) | Generates markdown for a constant definition. |
| [makeDescription()](/docs/doc/php/php\-functions\-doc/make\-description.md) | Generates markdown for a PHPDoc comment's summary and description. |
| [makeFunction()](/docs/doc/php/php\-functions\-doc/make\-function.md) | Generates markdown for a function or class method definition. |
| [makeFunctionParameters()](/docs/doc/php/php\-functions\-doc/make\-function\-parameters.md) | Generates markdown for any \@param statements found in the specified PHPDoc comment. |
| [makeFunctionParametersTable()](/docs/doc/php/php\-functions\-doc/make\-function\-parameters\-table.md) | Generates markdown for any \@param statements found in the specified PHPDoc comment in a table format. |
| [makeFunctionReturn()](/docs/doc/php/php\-functions\-doc/make\-function\-return.md) | Generates markdown for a \@return statement if found in the specified PHPDoc comment. |
| [makeFunctionReturnTable()](/docs/doc/php/php\-functions\-doc/make\-function\-return\-table.md) | Generates markdown for a \@return statement if found in the specified PHPDoc comment in a table format. |
| [makeFunctionThrows()](/docs/doc/php/php\-functions\-doc/make\-function\-throws.md) | Generates markdown for any \@throw statements found in the specified PHPDoc comment. |
| [makeFunctionThrowsTable()](/docs/doc/php/php\-functions\-doc/make\-function\-throws\-table.md) | Generates markdown for any \@throw statements found in the specified PHPDoc comment in a table format. |
| [makeFunctionsDescription()](/docs/doc/php/php\-functions\-doc/make\-functions\-description.md) | Generates markdown for the description of this documentation file. |
| [makeMarkLabels()](/docs/doc/php/php\-functions\-doc/make\-mark\-labels.md) | Generates markdown for labels when certain PHPDoc tags are present in a PHPDoc comment. |
| [makeName()](/docs/doc/php/php\-functions\-doc/make\-name.md) | Generates markdown for the name of this document. |
| [makeProperty()](/docs/doc/php/php\-functions\-doc/make\-property.md) | Generates markdown for a property definition. |
| [removeIgnoreableReflectors()](/docs/doc/php/php\-functions\-doc/remove\-ignoreable\-reflectors.md) | Removes any reflectors from the specified array that the current configuration indicates should be removed. |
